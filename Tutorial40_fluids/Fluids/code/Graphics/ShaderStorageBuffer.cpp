...
bool	ShaderStorageBuffer::Generate( const unsigned int structureSize, const unsigned int structureCount, const int flags ) { return false; }

bool	ShaderStorageBuffer::Generate( const unsigned int structureSize, const unsigned int structureCount ) { return false; }

void *	ShaderStorageBuffer::MapBuffer( const int bufferMask ) { return NULL; }
void	ShaderStorageBuffer::UnMapBuffer() {}
