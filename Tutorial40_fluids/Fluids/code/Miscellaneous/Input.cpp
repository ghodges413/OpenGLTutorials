...
// 512 bits for the keyboard
// 32 bits per integer = 16 integers per 512 bits
unsigned int g_keyboardbits[ 16 ];

void SerializeInput() {
	memset( g_keyboardbits, 0, sizeof( unsigned int ) * 16 );
	const bool * states = g_keyboard.m_keysDown;
