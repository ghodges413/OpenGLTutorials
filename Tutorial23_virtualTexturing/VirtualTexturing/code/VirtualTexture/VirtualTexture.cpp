...
void VirtualTexture::Init() {
	const char * fragShader = "data/Shaders/VirtualTexture/generatePageIDs.frag";
	const char * vertShader = "data/Shaders/VirtualTexture/generatePageIDs.vert";
	m_feedbackShader.LoadFromFile( fragShader, vertShader, NULL, NULL, NULL, NULL );

	fragShader = "data/Shaders/VirtualTexture/megatexture.frag";
	vertShader = "data/Shaders/VirtualTexture/megatexture.vert";
