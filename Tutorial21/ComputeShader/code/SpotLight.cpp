...
void SpotLight::Initialize() {
	mPosition = Vec3d( -200, 0, 200 );
	mDirection = Vec3d( 1, 0, -1 );
	...
	// Load shaders
	mShaderDepthOnly.LoadFromFile( "data/Shaders/depthOnly.fsh", "data/Shaders/depthOnly.vsh", NULL, NULL, NULL, NULL );
	mShaderDebug.LoadFromFile( "data/Shaders/simple.fsh", "data/Shaders/simple.vsh", NULL, NULL, NULL, NULL );
