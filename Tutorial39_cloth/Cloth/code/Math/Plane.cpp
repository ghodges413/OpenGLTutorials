...
/*
 ...
 =======================================
 */
Plane::planeSide_t Plane::SideDistribution( const Vec3 * const points, const int numPoints ) const {
	int numPositive( 0 );
	int numNegative( 0 );
...
/*
 ...
 =======================================
 */
// Plane::planeSide_t Plane::SideDistribution( const hbArray< Vec3 > & points ) const {
...
/*
 ...
 =======================================
 */
bool Plane::IntersectPlane( const Plane & rhs, Vec3 & start, Vec3 & dir ) const {
	...
	const Vec3 & n1	= mNormal;
	const Vec3 & n2	= rhs.mNormal;
	const Vec3 n3	= (n1.Cross( n2 )).Normalize();
	...
	const Vec3 ray1 = n1.Cross( n3 ).Normalize();
	const Vec3 ray2 = n2.Cross( n3 ).Normalize();
...
/*
 ...
 =======================================
 */
// bool Plane::IntersectSegment( const Vec3 & a, const Vec3 & b, float & t, Vec3 & p ) const {
...
/*
 ...
 =======================================
 */
bool Plane::IntersectRay( const Vec3 & start, const Vec3 & dir, float & t, Vec3 & p ) const {
	const Vec3 normDir = dir / dir.GetMagnitude();
