...
void Update() {
	...
	// Use A* to calculate the path from the token to the player
	g_navStart = g_spider.GetPosition();
	Vec3 nextpos = PathFind( g_navStart, g_navEnd );
