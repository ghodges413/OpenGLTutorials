...
// A render surface for off screen rendering
...
void DrawFrame( void ) {
...
#else
	// Positions for drawing full screen
	Vec3d positions[ 4 ] = {
		Vec3d( -1, 1, 0 ),
		Vec3d( -1, -1, 0 ),
		Vec3d( 1, -1, 0 ),
	...
	gShaderSimple.SetAndBindUniformTexture( "s_texture", 0, GL_TEXTURE_2D, gRenderSurface.GetColorTexture() );
	//gShaderSimple.SetAndBindUniformTexture( "s_texture", 0, GL_TEXTURE_2D, gRenderSurface.GetDepthTexture() );	// This will draw the depth buffer instead
...
int main( int argc, char ** argv ) {
	...
	// Create a render surface for offscreen rendering
