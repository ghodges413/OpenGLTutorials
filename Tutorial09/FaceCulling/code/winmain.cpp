...
void DrawFrame( void ) {
	...
	// This sets the rotation matrix.  Try other rotations, such as around X or Z axis
	float matTransform[ 16 ] = { 0 };
	myRotateY( angle, matTransform );
	...
	gShader.SetUniformMatrix4f( "matTransform", 1, false, matTransform );
