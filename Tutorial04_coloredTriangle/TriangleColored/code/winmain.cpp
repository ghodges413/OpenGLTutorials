...
void DrawFrame( void ) {
	...
	// Enalbe the use of color arrays and ignore the globally set color
	...
	// This is the number of dimensions (3 for xyz)
	const int size = 3;

	// The data type of the vertices (floating point)
	...
	glVertexPointer( size, type, stride, vertices );
